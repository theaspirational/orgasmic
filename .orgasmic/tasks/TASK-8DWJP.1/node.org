...
* BACKLOG TASK-8DWJP.1 Fix round for 8DWJP: route the conflict event into machines/<id>/tx/, detect autostash-pop conflicts, read conflicted paths from git, fence park_conflict behind a writer barrier    :e01mc:chain-review:
:PROPERTIES:
