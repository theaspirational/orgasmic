...
* IN_PROGRESS TASK-KA934.1.1 Fix round 2 for KA934.1: OCC conflict → 409, surface edit/delete stamps and tombstones in activity, pin the two test gaps :e01mc:chain-review:
:PROPERTIES:
:ID: TASK-KA934.1.1
:PRIORITY: P2
