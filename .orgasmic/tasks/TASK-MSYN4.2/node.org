...
* IN_REVIEW TASK-MSYN4.2 H2+H5: sync loop races the writer (commits .bak/.tmp sidecars, torn closes) and wedges silently on rebase conflict :e01mc:chain-review:
:PROPERTIES:
:ID: TASK-MSYN4.2
:PRIORITY: P1
:FIX_SUBTASK: t
