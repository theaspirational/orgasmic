...
* BACKLOG TASK-EPG6H.1.1 Fix round 2 for EPG6H.1: earlier-journal CLI case, parsed TIME compare (fail closed), per-candidate journal errors, drop journal_tx_entry round-trip    :e01mc:chain-review:
:PROPERTIES:
:ID: TASK-EPG6H.1.1
:PRIORITY: P1
