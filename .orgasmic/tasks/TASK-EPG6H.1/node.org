...
* DONE TASK-EPG6H.1 H3: torn-close repair arms read tx/ and machines/*/tx only, but task.state_transitioned now lives in journals — the operator-intent guard is dead :e01mc:chain-review:
:PROPERTIES:
:ID: TASK-EPG6H.1
:PRIORITY: P1
:FIX_SUBTASK: t
