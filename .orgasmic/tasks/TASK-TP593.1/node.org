...
* IN_PROGRESS TASK-TP593.1 M2+M3: eight tests that cannot fail — node_kernel real_data needs ORGASMIC_MIGRATED_DIR (set nowhere); seven live-corpus fixtures skip on every fresh clone :e01mc:chain-review:
:PROPERTIES:
:ID: TASK-TP593.1
:PRIORITY: P2
:FIX_SUBTASK: t
