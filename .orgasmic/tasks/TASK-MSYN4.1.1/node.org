...
* IN_PROGRESS TASK-MSYN4.1.1 fix round: org-file denylist must case-fold (APFS) and refuse tmp/; share the daemon-owned surface list with the writer gate :e01mc:chain-review:
:PROPERTIES:
:ID: TASK-MSYN4.1.1
:PRIORITY: P1
:FIX_SUBTASK: t
