...
* DONE TASK-JWHXH.1 H4+M1: views/ tracked on existing ledgers (only the scaffold ignores it) and never regenerated after incremental writes :e01mc:chain-review:
:PROPERTIES:
:ID: TASK-JWHXH.1
:PRIORITY: P1
:FIX_SUBTASK: t
