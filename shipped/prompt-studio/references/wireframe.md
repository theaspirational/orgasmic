...
This is orgasmic's shipped copy of the wireframe quality bar (snapshotted
from the visual-plan skill so the runtime is self-contained; the rules are
pinned to the renderer version they ship with). Read it in full before
