            ...
            .enumerate()
        {
            ...
            let resp = client
                ...
                .json(&json!({
                    ...
                    "project": "orgasmic",
                    "force_inert": true,
                    "request_id": format!("task-a6fgf-path-{idx}"),
                }))
                .send()
                .await
                .unwrap();
